...
/**
 * Class TrainingArray provides array of int numbers with methods that
 * 1) finds min element;
 * 2) finds max element;
 * 3) sorts array with Quicksort algorithm
 * Implements method sort(int[] array) with implementation of quick sort
 */
public class TrainingArray implements ArraySortable {

    /** Array of int numbers */
    private int[] array;

    /**
     * Constructor, that creates TrainingArray by number of elements
     * @param nElems        number of elements in array
     */
    public TrainingArray(int nElems) {
        array = new int[nElems];
    }

    /**
     * Constructor, that creates TrainingArray by given array
     * @param array         array of int numbers
     */
    public TrainingArray(int[] array) {
        this.array = array;
        checkArguments();
    }
